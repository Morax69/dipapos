            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_perusahaan" class="col-lg-3 col-lg-offset-1 control-label">Nama Perusahaan</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="path_logo" class="col-lg-3 col-lg-offset-1 control-label">Logo Perusahaan</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label for="tipe_nota" class="col-lg-3 col-lg-offset-1 control-label">Tipe Nota</label>
                        <div class="col-lg-2">
